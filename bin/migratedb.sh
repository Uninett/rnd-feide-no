...
echo "  mysqldump -u ${WORDPRESS_DB_USER} --password=xxx -h ${WORDPRESS_DB_HOST}  ${WORDPRESS_DB_NAME} | mysql -u ${WORDPRESS_DB_USER_TEST} --password=xxx -h ${WORDPRESS_DB_HOST} ${WORDPRESS_DB_NAME_TEST}"
